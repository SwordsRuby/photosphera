      ...
      <div class="gallery container flex-column gap-block-20px">
        ...
        <div class="gallery_block">
          ...
          <a
            id="img-block-1-2"
            href="#img-block-1-2"
            class="img-block block-img-gallery-2"
          >
            <img class="gallery-img" src="img/gallery/image(1).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-3"
            href="#img-block-1-3"
            class="img-block block-img-gallery-3"
          >
            <img class="gallery-img" src="img/gallery/image(2).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-4"
            href="#img-block-1-4"
            class="img-block block-img-gallery-4"
          >
            <img class="gallery-img" src="img/gallery/image(3).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-5"
            href="#img-block-1-5"
            class="img-block block-img-gallery-5"
          >
            <img class="gallery-img" src="img/gallery/image(4).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-6"
            href="#img-block-1-6"
            class="img-block block-img-gallery-6"
          >
            <img class="gallery-img" src="img/gallery/image(5).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-7"
            href="#img-block-1-7"
            class="img-block block-img-gallery-7"
          >
            <img class="gallery-img" src="img/gallery/image(6).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-8"
            href="#img-block-1-8"
            class="img-block block-img-gallery-8"
          >
            <img class="gallery-img" src="img/gallery/image(7).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-9"
            href="#img-block-1-9"
            class="img-block block-img-gallery-9"
          >
            <img class="gallery-img" src="img/gallery/image(8).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-10"
            href="#img-block-1-10"
            class="img-block block-img-gallery-10"
          >
            <img class="gallery-img" src="img/gallery/image(9).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-11"
            href="#img-block-1-11"
            class="img-block block-img-gallery-11"
          >
            <img class="gallery-img" src="img/gallery/image(10).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
          ...
          <a
            id="img-block-1-12"
            href="#img-block-1-12"
            class="img-block block-img-gallery-12"
          >
            <img class="gallery-img" src="img/gallery/image(11).png" alt="" />
            <div class="gallery-img-block">
              <div class="gallery-img-subblock">
                <div class="like-container scale">
                  <h3 class="like-numbers">121</h3>
