    ...
    <main>
      ...
      <div class="add-img-block container my-40">
        ...
        <form
          ...
          class="add-img-form-block my-40 flex-space-between mobile-column"
        >
          <!-- img-add-file-or-URL -->
          <div class="add-img-path-block gap-block-10px flex-column">
            <div class="add-img-file-path-block flex-center">
              <input type="file" name="addImgFile" id="add-img-file" />

              <div
                class="add-img-file-path-subblock flex-column gap-block-20px"
              >
                <h3 class="file-path-subblock-title">
                  <span class="red-file-choose">Выберите файл</span> или
                  перетащите его сюда
                </h3>
                <img
                  src="img/main/arrow-black.svg"
                ...
                />
                <p class="file-path-subblock-text">
          ...
          <div class="add-img-info-block flex-column gap-block-10px">
            ...
            <div class="add-img-info-buttons gap-block-10px mobile-column">
              ...
              >
              <input
                class="red-button add-img-button flex-center unactive-button"
                disabled
