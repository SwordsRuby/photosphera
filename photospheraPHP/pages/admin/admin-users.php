...
<html lang="ru">
  ...
  <body>
    ...
    <main>
      ...
      <div
        class="admin-categories-tag-catalog gap-block-20px flex-column container"
      >
        ...
        <div class="tag-admin-block gap-block-10px flex-wrap">
          <!-- card -->
          <div class="admin-card">
            <h2 class="admin-card-users-title">Цветная ромашка</h2>
            <a
              href="#"
          ...
          <!-- card -->
          <div class="admin-card">
            <h2 class="admin-card-users-title">Красная ромашка</h2>
            <a
              href="#"
